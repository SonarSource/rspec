...
In particular, the main branch corresponds to what will be integrated in the next version of the analyzers, i.e. what will be part of the next releases.
...
A <<Multi-Language workflow>> is more somewhat more involved.
