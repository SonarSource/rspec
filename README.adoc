...
You can add a comment anywhere you need in a rule by adding the following lines in the `*.adoc` file:
[source]
----
\ifdef::env-github,rspecator-view[]
John Doe (9 Jun 2021): my comment on the rule
\endif::env-github,rspecator-view[]
----
This way, your comment will only be visible on the Search Page (and won't be visible for the user for example).
