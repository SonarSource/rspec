...
If the https://learn.microsoft.com/en-us/dotnet/csharp/nullable-references[nullable context] is enabled, you can replace the ? with !, otherwise you should just remove it.
