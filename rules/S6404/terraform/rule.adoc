...
protect itself against attacks or theft on its GCP resources. +
...
GCP also provides the ability to grant public access to authenticated users.
The risk of data theft is the same. The only thing that changes is the ability
to track user access in the event of an incident.
