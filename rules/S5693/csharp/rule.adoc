...
public class MyController : Controller
{
    ...
    [RequestSizeLimit(10485760)] // Sensitive: 10MB is more than the recommended limit of 8MB
    ...
    [HttpPost]
    [RequestFormLimits(MultipartBodyLengthLimit = 10485760)] // Sensitive: 10MB is more than the recommended limit of 8MB
...
{
    [HttpPost]
    [RequestSizeLimit(8388608)] // Compliant: 8MB
    public IActionResult PostRequest(Model model)
    {
    // ...
    }
    ...
    [HttpPost]
    [RequestFormLimits(MultipartBodyLengthLimit = 8388608)] // Compliant: 8MB
    public IActionResult MultipartFormRequest(Model model)
    {
    // ...
    }
