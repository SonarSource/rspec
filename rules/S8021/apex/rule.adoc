 ...
 * Winter '26 Release Notes - https://help.salesforce.com/s/articleView?id=release-notes.rn_apex_userinfo_getroleandsubordinates.htm[Salesforce release notes detailing the deprecation of getRoleAndSubordinates()]
