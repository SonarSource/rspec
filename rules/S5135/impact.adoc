...
In this scenario, the attacker succeed in injecting an object of the expected
...
In this worst-case scenario, the attackers succeed in injecting an object of a
