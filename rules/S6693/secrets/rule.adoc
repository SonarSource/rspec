...
Depending on the information system the key is used to authenticate against the audit method might change. For example, on Linux systems, the system wide authentication logs could be used to audit recent authentication from an affected account.
