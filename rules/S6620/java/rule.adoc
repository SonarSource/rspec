...
It is not uncommon to have text in *bold*, _italic_, *_both_*. 
...
| Merged cells | They are not currently used |
| Borders | Most often all around |
| Nested tables | They are not currently used |
|===
...
Sometimes, the content on the included files can vary. 
