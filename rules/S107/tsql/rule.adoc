...
Another data structure alternative would be using the https://learn.microsoft.com/en-us/sql/t-sql/xml/xml-transact-sql[XML] data type to pass at once all the required data.
