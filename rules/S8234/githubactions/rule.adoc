...
jobs:
  test-job:
    ...
    steps:
      # This job only need 'contents: read' permission.
----
...
jobs:
  example:
    ...
    steps:
      - name: hello
        # This job only need 'contents: write' permission.
----
==== Compliant solution
...
jobs:
  test-job:
    ...
    runs-on: ubuntu-latest
    steps:
      # This job only has 'contents: read' permission.
----
...
jobs:
  example:
    ...
    steps:
      - name: hello
         # This job only has 'contents: write' permission.
----
