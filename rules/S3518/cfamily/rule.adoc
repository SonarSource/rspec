...
* https://github.com/isocpp/CppCoreGuidelines/blob/e49158a/CppCoreGuidelines.md#es105-dont-divide-by-integer-zero[{cpp} Core Guidelines ES.105] - Don't divide by integer zero
