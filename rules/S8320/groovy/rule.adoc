 ...
 * Groovy Documentation - https://groovy-lang.org/syntax.html#_gstring_and_string_hashcodes[Syntax]

 * Groovy Documentation - https://groovy-lang.org/groovy-dev-kit.html#Collections-Maps[Groovy development kit]
