...
Because the user input is not sanitized here and the used DOM API method is vulnerable to XSS, it is possible to inject arbitrary code in the user's browser through this example.
