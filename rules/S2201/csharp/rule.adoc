...
* LINQ methods,
* `[Pure]` methods,
* any method returning a build-in type (for example, string, int, etc.) or an Immutable collection (for example, `ImmutableArray`, `ImmutableDictionary` etc).
...
=== Documentation
* https://learn.microsoft.com/en-us/dotnet/api/system.diagnostics.contracts.pureattribute[PureAttribute documentation]
