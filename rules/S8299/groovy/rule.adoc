...
Add the `@CompileStatic` annotation to the AST transformation class. This will enable static compilation for the transformation code, improving its performance during the compilation process.
 ...
 * Groovy Metaprogramming Documentation - https://groovy-lang.org/metaprogramming.html[Official Groovy documentation on metaprogramming and AST transformations, which recommends using @CompileStatic for performance]
