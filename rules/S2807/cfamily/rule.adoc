...
* https://github.com/isocpp/CppCoreGuidelines/blob/e49158a/CppCoreGuidelines.md#c161-use-non-member-functions-for-symmetric-operators[{cpp} Core Guidelines C.161] - Use non-member functions for symmetric operators
