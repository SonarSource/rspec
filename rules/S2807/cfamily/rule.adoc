...
and disallows implicit conversion for left operands while allowing them for right operand.
...
or imaking interface more consistent by providing compound assignment counterparts for each supported operator.
