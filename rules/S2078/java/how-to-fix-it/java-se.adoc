...
Otherwise, here are the details showing how a popular framework implements it: https://github.com/bcgit/bc-java/blob/r1rv74/prov/src/main/java/org/bouncycastle/jce/provider/X509LDAPCertStoreSpi.java#L52-L70[Bouncy Castle Java].
