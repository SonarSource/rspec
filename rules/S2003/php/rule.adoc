...
Because including the same file multiple times could have unpredictable results, the `_once` versions are preferred.
...
* https://www.php.net/manual/en/function.require-once.php[require-once]
* https://www.php.net/manual/en/function.require.phpp[require]
* https://www.php.net/manual/en/function.include-once.php[include-once]
* https://www.php.net/manual/en/function.include.php[include]

=== Articles & blog posts

* https://stackoverflow.com/questions/2418473/difference-between-require-include-require-once-and-include-once[Stackoverflow Thread]
