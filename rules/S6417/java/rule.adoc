Generally it's not recommended to modify a collection while it's iterated. This may sometimes lead to a ConcurrentModificationException and it could be the source of incorrect behaviors in the code.
