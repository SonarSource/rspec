...
* https://github.com/isocpp/CppCoreGuidelines/blob/e49158a/CppCoreGuidelines.md#es23-prefer-the--initializer-syntax[{cpp} Core Guidelines ES.23] - Prefer the `{}`-initializer syntax
