This rule raises an issue when a `rescue` clause is used without specifying an exception class, creating a "bare rescue" that catches all StandardError exceptions.
