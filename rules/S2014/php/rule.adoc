...
In PHP, `$this` is a keyword used inside a class, which refers to the current class instance.
You have access to class properties and methods through the use of this keyword.
