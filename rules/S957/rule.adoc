...
* <code>do</code>-<code>while (0)</code> construct

Macros should not be used to define statements or parts of statements except for the use of the <code>do</code>-<code>while (0)</code> construct, or to redefine the syntax of the language. All brackets ( (), {}, and [] ) in a macro must be balanced
