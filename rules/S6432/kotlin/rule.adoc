...
fun encrypt(key: ByteArray, ptxt: ByteArray) {
    val nonce: ByteArray = "7cVgr5cbdCZV".toByteArray() // Noncompliant: Static initialization vector (IV)

    val gcmSpec  = GCMParameterSpec(128, nonce) // Noncompliant: Initialization vector (IV) configured
