...
The maximum number of non-well-known services used among all actions in the controller.
****
.sharedServicesLeniency
****
...
The maximum number of non-well-known services to duplicate when splitting responsibilities.
****
