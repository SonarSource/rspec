 ...
 * Go Blog: go fmt your code - https://go.dev/blog/gofmt[Blog post discussing mechanical transformations including the bytes.Compare to bytes.Equal optimization]
