...
This could lock up not just the program in question, but potentially everything that runs on the machine.
...
* Java SE Tutorial - https://docs.oracle.com/javase/tutorial/essential/exceptions/tryResourceClose.html[Try With Resources]
