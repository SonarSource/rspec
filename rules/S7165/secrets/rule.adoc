...
If attackers gain access to a New Relic API key, they might be able to gain access to inject forged data,
to retrieve information potentially private or to configure features in New Relic monitoring solutions.
