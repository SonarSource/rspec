...
Forgetting to await a promise is a frequent mistake. There are places where it makes no sense to use a promise object as it is. This is likely a bug as the developer forgot to resolve it.
