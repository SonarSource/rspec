...
new ApplicationListener(this, 'listener-https-explicit-constructor', {
  loadBalancer: alb,
  protocol: ApplicationProtocol.HTTP, // Sensitive
  port: 8080,
  open: true
...
new NetworkListener(this, 'listener-http-explicit-constructor', {
  loadBalancer: nlb,
  protocol: Protocol.HTTP, // Sensitive
  port: 8080
});
----
...
const loadBalancer = new LoadBalancer(this, 'LB1', {
    vpc,
    internetFacing: true,
    healthCheck: {
    port: 80,
