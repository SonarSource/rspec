...
* https://typescript-eslint.io/[typescript-eslint] - Rule https://github.com/typescript-eslint/typescript-eslint/blob/v7.18.0/packages/eslint-plugin/docs/rules/switch-exhaustiveness-check.mdx[switch-exhaustiveness-check]
=== Standards
