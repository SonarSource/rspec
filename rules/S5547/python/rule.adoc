...
https://cryptography.io/en/latest/installation/[pyca] library:
...
http://whitemans.ca/des.html[pydes] library:
...
Old https://pycrypto.readthedocs.io/en/latest/ [pycrypto] library and not maintained anymore:
