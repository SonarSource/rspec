...
Update the name of the constant to match the convention (lowerCamelCase), as well as all
usages of the name.
...
* https://dart.dev/tools/linter-rules/constant_identifier_names[Dart Lint rule]
