...
Leaking these keys can lead to unintended access to the functions and data they
control, during development time, for example.
...
* Or request authentication with the https://learn.microsoft.com/en-us/azure/app-service/environment/integrate-with-application-gateway[Azure App Service Environment].
