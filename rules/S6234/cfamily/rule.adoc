...
The use of ``++auto++`` reduces unnecessary boilerplate in situations where the type of the variable is apparent from the context. In other situations though, whether `auto` increases or decreases readability is a matter of personal taste.
