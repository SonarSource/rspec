...
The use of a comma in this context was deprecated in {cpp}20 and a real multi-dimensional subscript operator was introduced in {cpp}23.

=== Exceptions

Usage of the comma operator is tolerated in initializations and increment expressions of `for` loops.
