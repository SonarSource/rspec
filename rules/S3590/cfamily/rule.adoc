...
Both the C and {cpp} standards define freeing non-heap memory as _undefined behavior_.
...
* If manually managing dynamic memory, release the memory in the same scope where it was acquired.
