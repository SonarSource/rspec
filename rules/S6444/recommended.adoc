...
* It is recommended to specify a https://learn.microsoft.com/en-us/dotnet/standard/base-types/best-practices#use-time-out-values[``++matchTimeout++``] when executing a regular expression.
