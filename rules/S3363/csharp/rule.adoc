Within the context of Entity Framework, or Entity Framework Core, you shouldn't set a field of type `DateTime` or `DateTimeOffset` as the primary key of a table. 
