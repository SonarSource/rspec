...
* Java Documentation - https://docs.oracle.com/en/java/javase/21/security/java-api-xml-processing-jaxp-security-guide.html[Oracle Java Documentation] - Java API for XML Processing (JAXP) Security Guide

* Dom4j Library - https://dom4j.github.io/[Documentation]
* Jdom2 Library - http://www.jdom.org/[Documentation]
