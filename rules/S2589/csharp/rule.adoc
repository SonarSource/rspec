...
This also applies to conditional expression in https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/operators/null-coalescing-operator[conditional operator] when one of the operands always evaluates to `null`.
...
* The unnecessary operand is made essential
+
