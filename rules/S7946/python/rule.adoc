This rule raises an issue when custom formatting functions are defined for logging purposes, especially when they could be replaced with Python's built-in logging capabilities.
