...
In the bellow description there's nothing about *protected* inheritance. What I've done in rule's implementation, is applying the same logique to *private* and *protected*.
