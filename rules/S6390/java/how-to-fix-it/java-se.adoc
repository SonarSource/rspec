...
time is below a safe limit. This one should be evaluated and set to the lowest
possible time to ensure the application's operation and limit denial of service
attacks.
