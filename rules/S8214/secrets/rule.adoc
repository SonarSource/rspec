...
[source,javascript,diff-id=1,diff-type=noncompliant,subs="attributes"]
----
const hot = new Handsontable(container, {
    data: some,
    licenseKey: "a91c3-d7b0e-f9a2c-4e8b1-0d3f7" // Noncompliant
});
----

==== Compliant solution

[source,javascript,diff-id=1,diff-type=compliant,subs="attributes"]
----
const hot = new Handsontable(container, {
    data: some,
    licenseKey: process.env.HANDSONTABLE_LICENSE_KEY // Compliant
});
----
