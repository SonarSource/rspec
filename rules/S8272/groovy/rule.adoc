...
Add the `Cloneable` interface to the class declaration. This tells the JVM and other developers that the class supports cloning operations.
 ...
 * S1182 - https://rules.sonarsource.com/java/RSPEC-1182/[Classes that override "clone" should be "Cloneable" and call "super.clone()"]

 * S2158 - https://rules.sonarsource.com/java/RSPEC-2158/["Cloneable" should not be implemented]
