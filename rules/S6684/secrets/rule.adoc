...
* https://learn.microsoft.com/en-us/azure/api-management/api-management-subscriptions[Microsoft documentation] - Subscriptions in Azure API Management
* https://learn.microsoft.com/en-us/azure/azure-monitor/essentials/activity-log[Microsoft documentation] - Azure Monitor activity log
