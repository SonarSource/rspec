:example_env: CARTO_API_ACCESS_TOKEN
:example_name: carto_api_access_token
:example_secret: eyJhbGciOiJIUzI1NiJ9.eyJhIjoiYWJjZGVmZyIsIm5hbWUiOiJFeGFtcGxlIFRva2VuIn0.j16idNXtdBrJ5Ly6-n7HQI70-UBbtdVEL8NUUsgaytg
:secret_type: secret
