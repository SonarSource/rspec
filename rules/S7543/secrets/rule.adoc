:example_env: FRESHCHAT_API_TOKEN
:example_name: freshchat_api_token
:example_secret: eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhdWQiOiJmcmVzaGNoYXQifQ.AZrhYLbyxJ4mR88PsvPEv8lNGIf_3Re0RGRp7NETszI
:secret_type: secret
