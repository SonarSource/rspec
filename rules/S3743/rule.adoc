...
* https://www.hlsl.co.uk/blog/2017/12/1/c-noexcept-and-move-constructors-effect-on-performance-in-stl-containers[C++ noexcept and move constructors effect on performance in STL containers]
