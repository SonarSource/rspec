:example_env: CONTENTFUL_CONTENT_DELIVERY_API_KEY
:example_name: contentful_content_delivery_api_key
:example_secret: oVnkJf9tZE6EFwhoMqcTmbkoeN11du1L3H9x3lruESc
:secret_type: secret
