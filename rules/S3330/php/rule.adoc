...
By default https://www.php.net/manual/en/function.setcookie.php[<code>setcookie</code>] and https://www.php.net/manual/en/function.setrawcookie.php[<code>setrawcookie</code>] functions set <code>httpOnly</code> flag to _false_ (the seventh argument) and so cookies can be stolen easily in case of XSS vulnerability:
