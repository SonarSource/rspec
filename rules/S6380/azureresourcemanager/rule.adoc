    ...
    "resources": [
        {
            ...
            "resources": [
                ...
                },
                {
                    ...
                    "properties": {
                        "clientId": "myClientId",
                        "displayName": "OpenID Provider",
                        "metadataEndpoint": "<a metadata endpoint URI>"
                    }
                }
            ]
        }
...
* For ``Microsoft.ApiManagement/service/openidConnectProviders`` (if it is missing): Omitting the ``openidConnectProviders`` resource disables authentication. Make sure it is safe here.
...
* For ``Microsoft.ApiManagement/service/openidConnectProviders`` (if it is missing): Highlight the ``ApiManagement/service`` resource.
