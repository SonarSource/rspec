...
* {cpp} Core Guidelines - https://github.com/isocpp/CppCoreGuidelines/blob/036324/CppCoreGuidelines.md#Rc-standalone[C.7 Don't define a class or enum and declare a variable of its type in the same statement]
