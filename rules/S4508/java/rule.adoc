...
* ikkisoft's <code>SerialKiller</code>
* Apache Commons Class IO's <code>ValidatingObjectInputStream</code>
* contrast-rO0's <code>SafeObjectInputStream</code>
