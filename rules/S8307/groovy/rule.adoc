...
----
String name = "Guillaume"; // Noncompliant
 ...
 * Groovy Language Documentation - https://groovy-lang.org/syntax.html[Official documentation on Groovy syntax and conventions]

=== Related rules

 * RSPEC-2959 - https://rules.sonarsource.com/java/RSPEC-2959/[Similar rule for Java regarding unnecessary semicolons]
