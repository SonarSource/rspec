...
When using an object in a string context, a developer wants to express the state of an object, so obtaining `[object Object]` is probably not the intended behaviour and might even denote a bug.
