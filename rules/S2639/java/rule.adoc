...
[source,java]
----
String clean = str.replaceAll("|","_"); // Noncompliant; yields _/_F_i_l_e_|_N_a_m_e_._t_x_t_
String clean2 = str.replaceFirst("|","_"); // Noncompliant; 
----
...
[source,java]
----
String clean = str.replaceAll(File.separator, ""); // Noncompliant; exception on Windows
String clean2 = str.replaceFirst(File.separator, ""); // Noncompliant;
----
