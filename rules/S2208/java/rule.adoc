...
Depending on your IDE you can solve this issue almost automatically. Look for **Organize/Optimize imports** actions. These actions can also often be applied automatically on save. __Note:__ To make this work properly, IDE settings must be adjusted and set to a very high allowed class count usage before using wildcards.
