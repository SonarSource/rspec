...
Public Class ExampleController
    ...
    Public Sub Example(filename As String)
        Dim path As String = Path.Combine(TargetDirectory, filename)
...
Public Class ExampleController
    ...
    Public Sub Example(filename As String)
        Dim path As String = Path.Combine(TargetDirectory, filename)
        Dim canonicalDestinationPath As String = Path.GetFullPath(path)
...
Public Sub Example(filename As String)
    Dim canonicalDestinationPath As String = Path.GetFullPath(filename)
