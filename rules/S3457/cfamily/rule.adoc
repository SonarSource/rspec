...
Starting with {cpp}20, https://en.cppreference.com/w/cpp/utility/format/format[`std::format`] should be preferred, as it is more readable and validated at compile-time, making it more secure. Rule S6494 covers that.
