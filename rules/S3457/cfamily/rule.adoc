...
To avoid issues, a developer should ensure that the provided arguments match format specifiers. If possible, `std::format` from {cpp}20 should be preferred.
...
* {cpp} reference - https://en.cppreference.com/w/cpp/utility/format/format[`std::format` starting from {cpp}20]
* {cpp} reference - https://en.cppreference.com/w/cpp/io/print[`std::print` starting from {cpp}23]
