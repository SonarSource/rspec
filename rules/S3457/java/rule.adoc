...
Note that, a developer deliberately choosing to use a less portable format specifier, to have a byte-consistent output across platforms for instance, might trigger the rule in an inappropriate case.
However, as a principle, developers should be intentional in their choice of format specifiers.
