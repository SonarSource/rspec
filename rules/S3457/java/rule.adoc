...
Note that https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/text/MessageFormat.html[MessageFormat] is used by most logging mechanism, for example `java.util.logging.Logger`, thus the _single quote_ must be escaped by a _double single quote_.
