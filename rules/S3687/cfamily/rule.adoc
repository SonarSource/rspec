...
Since local variables and data members are totalIy within the purview of the {cpp}language, they can't change their value without compiler knowledge: It makes no sense for them to be `volatile`.
