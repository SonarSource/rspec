...
* https://github.com/isocpp/CppCoreGuidelines/blob/e49158a/CppCoreGuidelines.md#cp200-use-volatile-only-to-talk-to-non-c-memory[{cpp} Core Guidelines CP.200] - Use `volatile` only to talk to non-C++ memory
