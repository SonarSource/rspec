...
For https://azure.microsoft.com/fr-fr/services/key-vault/[Key Vaults] since 4.42.0:
...
For https://azure.microsoft.com/fr-fr/services/key-vault/[Key Vaults] before 4.42.0:
