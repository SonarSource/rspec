...
resource "google_project_iam_custom_role" "example" {
  permissions = [ # Sensitive
    "resourcemanager.projects.create", # Sensitive permission (read-write)
    "resourcemanager.projects.delete", # Sensitive permission (destructive)
    "resourcemanager.projects.get",
    "resourcemanager.projects.list",
    "run.services.create", # Sensitive permission (read-write)
    "run.services.delete", # Sensitive permission (destructive)
    "run.services.get",
...
* Secondary Message: Sensitive permission
