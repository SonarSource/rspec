...
In some rare cases, redundant cast might be justifiable. For example, when casting from platform dependant type:
...
* Geeksforgeeks - https://www.geeksforgeeks.org/type-conversion-c[Type Conversion C]
