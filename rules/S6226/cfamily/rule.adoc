...
NOTE: This rule is disabled on Windows because ``\[[no_unique_address]]`` isn't supported by MSVC and Clang on this platform. See https://devblogs.microsoft.com/cppblog/msvc-cpp20-and-the-std-cpp20-switch/#c20-no_unique_address[MSVC C{pp}20 and the /std:c{pp}20 Switch].
