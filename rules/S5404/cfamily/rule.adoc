...
* https://github.com/isocpp/CppCoreGuidelines/blob/e49158a/CppCoreGuidelines.md#cp42-dont-wait-without-a-condition[{cpp} Core Guidelines CP.42] - Don't `wait` without a condition
