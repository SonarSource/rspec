...
* https://github.com/isocpp/CppCoreGuidelines/blob/e49158a/CppCoreGuidelines.md#cp43-minimize-time-spent-in-a-critical-section[{cpp} Core Guidelines CP.43] - Minimize time spent in a critical section
