...
Convert the static method to an instance method to make it compatible with @TimedInterrupt.
 ...
 * Groovy Metaprogramming - TimedInterrupt - https://groovy-lang.org/metaprogramming.html#xform-TimedInterrupt[Official Groovy documentation explaining the @TimedInterrupt transformation and its limitations]
