...
[source,vbnet]
----
Public Function GetEntities(dbContext As MyDbContext, ids As List(Of Integer)) As List(Of MyEntities)
    Return dbContext.MyEntities.Where(Function(e) ids.Any(Function(i) e.Id = i)).ToList()
End Function
----
