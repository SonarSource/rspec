...
API calls can be used to create, update and delete tilesets, datasets and map
styles. These resources can be used to create customized maps for use in your
application.

If an attacker has access to a secret access token, they may be able to alter
these resources and deface the maps shown in your application, or prevent the
mapping functionality from working entirely.
