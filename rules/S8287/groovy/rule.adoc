...
void testUserCreation() {
    ...
    // No verification of user properties
}
----
...
def "should process order"() {
    ...
    // Missing then block with assertions
}
----
 ...
 * Groovy Testing Guide - https://groovy-lang.org/testing.html[Official Groovy documentation on testing practices and assertion methods]

 * JUnit 5 User Guide - Assertions - https://junit.org/junit5/docs/current/user-guide/#writing-tests-assertions[Comprehensive guide to JUnit 5 assertion methods and best practices]
 ...
 * RSPEC-2699 - https://rules.sonarsource.com/csharp/RSPEC-2699/[Tests should include assertions (C# implementation)]
