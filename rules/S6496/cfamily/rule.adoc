Objects of small sizes, i.e., up to `2 * sizeof(void*)` bytes, whose types are trivially copy-constructible and destructible should be passed by value.
...
----
Parameters passed by value cannot alias.
