...
* https://isocpp.github.io/CppCoreGuidelines/CppCoreGuidelines#i4-make-interfaces-precisely-and-strongly-typed[C++ Core Guidelines I.4] - Make interfaces precisely and strongly typed
* https://isocpp.github.io/CppCoreGuidelines/CppCoreGuidelines#t3-use-templates-to-express-containers-and-ranges[C++ Core Guidelines T.3] - Use templates to express containers and ranges
