...
While the copy constructor does make a full copy by allocating memory and then copying the ``++other++`` object's array values into the freshly allocated memory, the move constructor only assignes the pointer to point to ``++other++``'s dynamically allocated memory.
...
* https://en.cppreference.com/w/cpp/language/move_constructor[CPP Reference] - Move constructors

=== Conference presentations

* https://www.youtube.com/watch?v=St0MNEU5b0o&ab_channel=CppCon[CppCon 2019] Back to Basics: Move Semantics (part 1 of 2) - Klaus Igelberger
* https://www.youtube.com/watch?v=pIzaZbKUw2s&ab_channel=CppCon[CppCon 2019] Back to Basics: Move Semantics (part 2 of 2) - Klaus Igelberger
