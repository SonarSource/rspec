...
{
    [TestMethod]
    public void Add_SingleNumber_ReturnsSameNumber() => Validator.IsSameNumber(0); // Compliant
}

public static class Validator
{
    [AssertionMethod]
    public static void IsSameNumber(int value)
	{
		var stringCalculator = new StringCalculator();
		if (stringCalculator.Add(value.ToString()) != value)
		{
