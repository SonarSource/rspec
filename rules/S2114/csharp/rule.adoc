...
Passing a collection as an argument to the collection's own method is a code defect. There is no reason to add or concatenate a list to itself, and it can lead to reduced readability, as well as unexpected side effects.
