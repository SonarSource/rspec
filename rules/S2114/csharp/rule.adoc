...
Exceptions to this rule are the methods https://learn.microsoft.com/en-us/dotnet/api/system.collections.generic.list-1.addrange[`AddRange`] and https://learn.microsoft.com/en-us/dotnet/api/system.linq.enumerable.concat[`Concat`], since the developer
can use them to multiply the list elements or the list itself respectively.
