...
This rule raises no issue when the type returned by ``++__len__++`` is a class implementing the https://docs.python.org/3/reference/datamodel.html#object.__index__[``++__index__++``] special method.
