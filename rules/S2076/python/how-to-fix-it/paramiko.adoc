...
Here, the `quote` function from the `shlex` is used to encode the
user-controlled command argument. It ensures that no additional argument can
be added and special shell characters can not be used to escape the trusted
commands.
