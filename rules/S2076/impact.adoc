...
section. The difference is that the attacker also manages to elevate his privileges
as an administrator and attack other servers.

Depending on the underlying servers of the web application,
