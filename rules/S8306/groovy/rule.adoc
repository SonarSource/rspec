...
Add braces around the statement body of control structures, even for single statements.
 ...
 * CodeNarc Braces Rules - https://codenarc.org/codenarc-rules-braces.html[Documentation for CodeNarc rules that enforce brace usage in control structures]

 * Groovy Style Guide - https://groovy-lang.org/style-guide.html[Official Groovy style guide with coding conventions and best practices]
 ...
 * RSPEC-121 - https://rules.sonarsource.com/java/RSPEC-121/[Control structures should use curly braces (Java implementation)]
