...
When you are saving a number that is too big or contains a fraction that is not expressible in the 64-bit floating-point, it gets rounded which will lead to errors in computation.
