...
A user can legitimately run code on a system, depending on internal business
logic or operational management shells. However, they can also execute code
thanks to malicious actions, such as vulnerability exploits in a service that
the container hosts.
