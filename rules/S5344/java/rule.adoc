...
* https://docs.spring.io/spring-security/site/docs/current/api/org/springframework/security/crypto/bcrypt/BCryptPasswordEncoder.html[Spring Framework Security Documentation] - Class BCryptPasswordEncoder
