...
Another scenario is when some data might need to be mocked and a delay needs to be introduced.
One example of this is when using https://github.com/moq/moq4[Moq].
