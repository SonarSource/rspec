...
Furthermore, this rule ignores functional casts when creating an object of the same type (copy) of the object or leads to calls to constructors, because their purpose is clear and no dangerous conversion can happen.
