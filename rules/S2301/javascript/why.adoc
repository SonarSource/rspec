...
A selector argument is a ``++boolean++`` argument that's used to determine which of two paths to take through a method. Specifying such an argument may seem innocuous, particularly if it's well named.
