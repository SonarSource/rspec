...
To prevent these vulnerabilities, Domain Name System Security Extensions (DNSSEC) ensure integrity and authenticity of DNS data by digitally signing DNS zones.
