...
Many lambda expressions have only one parameter, the compiler can determine by context the parameter type. Thus when using `it`, you do not need to declare the type for the `it` parameter.
