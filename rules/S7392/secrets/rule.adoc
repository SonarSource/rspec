:example_env: ZOOM_API_JWT
:example_name: zoom_api_jwt
:example_secret: eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhdWQiOm51bGwsImluZm8iOiJleGFtcGxlIHNlY3JldCJ9.kQavK5ZNIemsC6O4TEsCxOS71KaqycjbdaAYLF3WQYE
:secret_type: secret
