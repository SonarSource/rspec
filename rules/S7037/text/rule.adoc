...
Replace the usage of the profane language with neutral and inclusive terminology.
...
Remove the usage of this profane language and replace it with neutral and inclusive terminology.

=== Highlighting

Highlight the usage of the profane language.
