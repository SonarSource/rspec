`+C++17+` introduced the ability to create and initialize a variable within the condition of `+if+` and `+switch+` statements. Using this new feature simplifies common code patterns and helps in giving variables the right scope.
