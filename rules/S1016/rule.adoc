For code compliant with C++98 or C++03 standards, declaring overriding virtual functions with the `+virtual+` keyword removes the need to check the base class to determine whether a function is virtual.
