...
* MITRE - https://cwe.mitre.org/data/definitions/798[CWE-209: Generation of Error Message Containing Sensitive Information]
* MITRE - https://cwe.mitre.org/data/definitions/259[CWE-489: Active Debug Code] 
