 ...
 * Groovy Language Documentation - Star Import - https://groovy-lang.org/structure.html#_star_import[Official Groovy documentation explaining star imports and their potential issues]
