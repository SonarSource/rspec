...
[source,text,diff-id=1,diff-type=noncompliant,subs="attributes"]
----
# .pypirc file
[name]
Repository = https://pkgs.dev.azure.com/redacted
username = redacted
password = bsguDUAAVrveqqbJBMeWq7IFdzUKyYXGgaC3iOPxajXX5snTp4Dr  # Noncompliant
----

==== Compliant solution
[source,text,diff-id=1,diff-type=compliant,subs="attributes"]
----
# .pypirc file
[name]
Repository = https://pkgs.dev.azure.com/redacted
