...
__Note:__ the code is overly complex here, to illustrate the purpose.
...
Checking for the edge case first flattens the `if` and reduces the cognitive complexity to 3.
