...
* https://www.securecoding.cert.org/confluence/x/g4HWAw[CERT, FIO01-J.] - Create files with appropriate access permissions
* https://www.securecoding.cert.org/confluence/x/KQU[CERT, FIO06-C.] - Create files with appropriate access permissions
