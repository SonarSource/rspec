Calling <code>COMMIT</code> or <code>ROLLBACK</code> from within a trigger will lead to an <code>ORA-04092</code> exception, unless the trigger has its own autonomous transaction.
