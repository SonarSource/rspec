...
* Encapsulate the field
    ...
    . Define methods to get and set the value of the field. These methods are commonly known as getter and setter methods and are prefixed by `get` and `set` followed by the name of the field.
