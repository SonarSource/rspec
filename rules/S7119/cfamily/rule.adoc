...
especially in cases when older {cpp} standard.
The most robust solution of refactoring the global variable into a static function variable,
requires replacing references to variables with the call to newly used functions.
