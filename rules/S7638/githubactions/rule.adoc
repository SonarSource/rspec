  ...
  set_env:
    ...
    steps:
      - env:
        ...
        run: |
          curl http://example.com?echo=::set-env%20name=MESSAGE::hello
          # If the HTTP response echoes contain "::set-env name=MESSAGE::hello",
          # the MESSAGE is set for the rest of the steps.
      - run: |
