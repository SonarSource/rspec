...
[source,vbnet,diff-id=21,diff-type=noncompliant]
----
@page "/"

@(CType(tainted, MarkupString))  @* Noncompliant *@

@code
    <SupplyParameterFromQuery>
    Private Property tainted As String = ""
End Code
----

==== Compliant solution

[source,vbnet,diff-id=21,diff-type=compliant]
----
@page "/"
