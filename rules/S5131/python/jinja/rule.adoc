...
The following code is vulnerable to Cross-Site Scripting because auto-escaping of special HTML characters has been disabled. Enable auto-escaping by moving the dynamic HTML content to the template engine.
