Exposing administrative services can lead to unauthorized access to pods or escalation of privilege inside pods.
...
containers:
    - name: applications
        ...
        ports:
        - containerPort: 22  # Sensitive: merely informative, removing this property does not
                             # close port 22.
----
