...
In the application manifest element of an android application, setting ``https://developer.android.com/guide/topics/manifest/application-element#debug[debuggable]`` property to ``++true++`` makes the application debuggable.
...
* The app is distributed to end users with the ``++debuggable++`` property is set to _true_
