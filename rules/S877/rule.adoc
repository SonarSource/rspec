...
* https://github.com/isocpp/CppCoreGuidelines/blob/036324/CppCoreGuidelines.md#Ro-address-of[C++ Core Guidelines C.166] - Overload unary `+&+` only as part of a system of smart pointers and references
