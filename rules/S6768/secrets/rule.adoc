...
Typeform often is used to store private information that users have shared
through their forms. This is called
...
An attacker can use the Typeform access token to lure them into links to
