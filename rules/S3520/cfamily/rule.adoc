...
Both objects are created from the raw pointer. This leads to them having individual control blocks, resulting in both attempting to release the original memory area.
