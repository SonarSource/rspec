...
void doSomething(int size) {
  ...
  if (condition) {
    ...
    // Alternatively, the call to free here can be removed since another will happen later
  }
...
void doSomething(int size) {
  ...
  if (condition) {
    ...
    // Alternatively, the invocation of delete here can be removed since another will happen later
  }
