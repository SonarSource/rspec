 ...
 * Groovy Truth and Boolean Expressions - https://groovy-lang.org/semantics.html#_boolean_expressions[Official Groovy documentation on boolean expressions and truth evaluation]

 * Java Short-Circuit Evaluation - https://docs.oracle.com/javase/tutorial/java/nutsandbolts/op2.html[Oracle's Java tutorial explaining short-circuit evaluation of logical operators]
 ...
 * RSPEC-2259 - https://rules.sonarsource.com/java/RSPEC-2259/[Null pointers should not be dereferenced]
