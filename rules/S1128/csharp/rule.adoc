...
[source,csharp]
----
global using System.Net.Sockets; // Compliant
----
...
using System.IO;
using System.Linq;
using System.IO;                       // Noncompliant - System.IO is imported twice
...
using static System.IO.FileStream;     // Noncompliant - FileStream is not used in this file
using Reader = System.IO.BinaryReader; // Noncompliant - aliased type is not used in this file
