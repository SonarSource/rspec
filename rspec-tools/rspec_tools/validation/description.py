...
ACCEPTED_PROGRESSIVE_EDUCATION_SECTION_NAMES: Final[list[str]] = parse_names('rspec-tools/rspec_tools/validation/names/progressive_education_section_names.adoc')
