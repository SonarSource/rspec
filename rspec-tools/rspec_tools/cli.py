...
@click.option(
    "--user", required=False, help="GitHub username for pull request assignee"
)
@click.option(
    "--dry-run/--no-dry-run",
    default=False,
    help="Only print broken links without creating PRs",
)
def replace_broken_links(d, r=None, user=None, dry_run=False):
