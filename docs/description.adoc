...
Most sections and subsections of the educational rule format are optional, only the `Why is this an issue?` main section is mandatory. 
...
This section can include multiple concrete threats as well. This is the place to talk about the impacts to the software(e.g. security, maintainability, etc.)
