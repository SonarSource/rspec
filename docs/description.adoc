...
This section aims to talk about the impacts on the software, depending on the code qualities this issue is linked to: security, reliability, or maintainability. *(see <<metadata.adoc#,impacts>>.)*
+
