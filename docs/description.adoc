...
This section aims to talk about the impacts on the software, depending on the code qualities this issue is linked to: security, reliability, or maintainability. *(see [docs/metadata#impacts](https://github.com/SonarSource/rspec/blob/master/docs/metadata.adoc#code-field).)*
+
